...
#define ROOM_SIDE_WIDTH 1 // Máximo de unidades de deslocamento para o lado
#define ROOM_WIDTH 3 // Máximo de espaços no eixo horizontal (sempre impar, considerando que deve sempre haver um centro, esquerda e direita)
#define ROOM_LENGTH 4 // Máximo de unidades de deslocamento para a frente 
